...
<body>
	<form:form modelAttribute="customer" action="${pageContext.request.contextPath}/addCustomer" method="post">
		<table>
			<tr>
			...
			<tr>
				...
				<td><form:input path="customer_name" size="30" maxlength="30"/></td>
			</tr>
			
			<tr>
				<td><form:label path="email">email</form:label></td>
				<td><form:input path="email" size="20" maxlength="20"/></td>
			</tr>
